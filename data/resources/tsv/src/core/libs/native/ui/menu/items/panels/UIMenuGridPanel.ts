    ...
    if (
      ...
      (async () => {
        ...
        while (Game.isDisabledControlPressed(0, Control.Attack)) {
          await Wait(0);
          let cX = (global.GetControlNormal(0, Control.CursorX) - drawOffset.X) * Menu.screenWidth;
          let cY = (global.GetControlNormal(0, Control.CursorY) - drawOffset.Y) * Menu.screenHeight;

...
export class Sprite {
  ...
  public loadTextureDictionary(): void {
    global.RequestStreamedTextureDict(this._textureDict, true);
  ...
  public get IsTextureDictionaryLoaded(): boolean {
    return global.HasStreamedTextureDictLoaded(this._textureDict);
  }
  ...
  public draw(
    ...
    if (loadTexture) {
      if (!global.HasStreamedTextureDictLoaded(textureDictionary)) {
        global.RequestStreamedTextureDict(textureDictionary, false);
      }
    }

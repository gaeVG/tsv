...
export class Model {
  ...
  public get IsValid(): boolean {
    return global.IsModelValid(this.hash);
  }
  ...
  public get IsInCdImage(): boolean {
    return global.IsModelInCdimage(this.hash);
  }
  ...
  public get IsLoaded(): boolean {
    return global.HasModelLoaded(this.hash);
  }
  ...
  public get IsCollisionLoaded(): boolean {
    return global.HasCollisionForModelLoaded(this.hash);
  }
  ...
  public get IsBicycle(): boolean {
    return global.IsThisModelABicycle(this.hash);
  }
  ...
  public get IsBike(): boolean {
    return global.IsThisModelABike(this.hash);
  }
  ...
  public get IsBoat(): boolean {
    return global.IsThisModelABoat(this.hash);
  }
  ...
  public get IsCar(): boolean {
    return global.IsThisModelACar(this.hash);
  }
  ...
  public get IsHelicopter(): boolean {
    return global.IsThisModelAHeli(this.hash);
  }
  ...
  public get IsPed(): boolean {
    return global.IsModelAPed(this.hash);
  }
  ...
  public get IsPlane(): boolean {
    return global.IsThisModelAPlane(this.hash);
  }
  ...
  public get IsProp(): boolean {
    return this.IsValid && !this.IsPed && !this.IsVehicle && !global.IsWeaponValid(this.hash);
  }
  ...
  public get IsQuadbike(): boolean {
    return global.IsThisModelAQuadbike(this.hash);
  }
  ...
  public get IsTrain(): boolean {
    return global.IsThisModelATrain(this.hash);
  }
  ...
  public get IsVehicle(): boolean {
    return global.IsModelAVehicle(this.hash);
  }
  ...
  public get Dimensions(): Dimensions {
    const [minArray, maxArray] = global.GetModelDimensions(this.hash);
  ...
  public request(timeout = 1000): Promise<boolean> {
    return new Promise(resolve => {
      ...
      global.RequestModel(this.hash);
      const start = GetGameTimer();
      const interval = setInterval(() => {
        if (this.IsLoaded || global.GetGameTimer() - start >= timeout) {
  ...
  public markAsNoLongerNeeded(): void {
    global.SetModelAsNoLongerNeeded(this.hash);
  }
}

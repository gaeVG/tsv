...
export class ParticleEffectAsset {
  ...
  public get IsLoaded(): boolean {
    return global.HasNamedPtfxAssetLoaded(this.assetName);
  }
  ...
  public startNonLoopedAtCoord(
    ...
    global.SetPtfxAssetNextCall(this.assetName);
    return (
      global.StartParticleFxLoopedAtCoord(
        effectName,
        pos.x,
        pos.y,
        pos.z,
  ...
  public startNonLoopedOnEntity(
    ...
    const invertAxisFlags = invertAxis.flags;
    global.SetPtfxAssetNextCall(this.assetName);
    return !!global.StartParticleFxLoopedOnEntity(
      effectName,
      entity.Handle,
      off.x,
      off.y,
  ...
  public request(timeout: number): Promise<boolean> {
    return new Promise((resolve) => {
      if (!this.IsLoaded) {
        global.RequestNamedPtfxAsset(this.assetName);
  ...
  public markAsNoLongerNeeded(): void {
    global.RemoveNamedPtfxAsset(this.assetName);
  }

...
export class RelationshipGroup {
  ...
  constructor(name: string) {
    const [, groupHash] = global.AddRelationshipGroup(name);
    this.hash = groupHash;
  }
  ...
  public getRelationshipBetweenGroups(targetGroup: RelationshipGroup): Relationship {
    return global.GetRelationshipBetweenGroups(this.Hash, targetGroup.Hash);
  }
  ...
  public setRelationshipBetweenGroups(
    ...
    global.SetRelationshipBetweenGroups(Number(relationship), this.Hash, targetGroup.Hash);

    if (biDirectionally) {
      global.SetRelationshipBetweenGroups(Number(relationship), targetGroup.Hash, this.Hash);
    }
  }
  ...
  public clearRelationshipBetweenGroups(
    ...
    global.ClearRelationshipBetweenGroups(Number(relationship), this.Hash, targetGroup.Hash);

    if (biDirectionally) {
      global.ClearRelationshipBetweenGroups(Number(relationship), targetGroup.Hash, this.Hash);
    }
  }
   ...
   */
  public remove(): void {
    global.RemoveRelationshipGroup(this.Hash);
  }
}

...
export class Rope {
  ...
  public get Length(): number {
    return global.GetRopeLength(this.handle);
  }
  ...
  public set Length(length: number) {
    global.RopeForceLength(this.handle, length);
  }
  ...
  public get VertexCount(): number {
    return global.GetRopeVertexCount(this.handle);
  }
  ...
  public resetLength(reset: boolean): void {
    global.RopeResetLength(this.handle, reset ? 1 : this.Length);
  }
  ...
  public activatePhysics(): void {
    global.ActivatePhysics(this.handle);
  }
  ...
  public attachEntity(entity: Entity, position: Vector3): void {
    global.AttachRopeToEntity(this.handle, entity.Handle, position.x, position.y, position.z, false);
  }
  ...
  public detachEntity(entity: Entity): void {
    global.DetachRopeFromEntity(this.handle, entity.Handle);
  }
  ...
  public pinVertex(vertex: number, position: Vector3): void {
    global.PinRopeVertex(this.handle, vertex, position.x, position.y, position.z);
  }
  ...
  public unpinVertex(vertex: number): void {
    global.UnpinRopeVertex(this.handle, vertex);
  }
  ...
  public getVertexCoord(vertex: number): Vector3 {
    return Vector3.fromArray(global.GetRopeVertexCoord(this.handle, vertex));
  }
  ...
  public exists(): boolean {
    const [exists] = global.DoesRopeExist(this.handle);
    return exists;
  }
}

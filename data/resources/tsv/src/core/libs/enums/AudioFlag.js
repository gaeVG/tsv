...
(function (AudioFlag) {
  ...
  AudioFlag[(AudioFlag['AllowPainAndAmbientSpeechToPlayDuringCutscene'] = 3)] =
    'AllowPainAndAmbientSpeechToPlayDuringCutscene';
  AudioFlag[(AudioFlag['AllowPlayerAIOnMission'] = 4)] = 'AllowPlayerAIOnMission';
  AudioFlag[(AudioFlag['AllowPoliceScannerWhenPlayerHasNoControl'] = 5)] =
  ...
  AudioFlag[(AudioFlag['DisableAbortConversationForDeathAndInjury'] = 11)] =
    'DisableAbortConversationForDeathAndInjury';
  AudioFlag[(AudioFlag['DisableAbortConversationForRagdoll'] = 12)] =
    'DisableAbortConversationForRagdoll';
  AudioFlag[(AudioFlag['DisableBarks'] = 13)] = 'DisableBarks';
  AudioFlag[(AudioFlag['DisableFlightMusic'] = 14)] = 'DisableFlightMusic';
  AudioFlag[(AudioFlag['DisableReplayScriptStreamRecording'] = 15)] =
  ...
  AudioFlag[(AudioFlag['HoldMissionCompleteWhenPrepared'] = 21)] =
  ...
  AudioFlag[(AudioFlag['OnlyAllowScriptTriggerPoliceScanner'] = 27)] =
